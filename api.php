        ...
        if (isset($_POST['action'])) {
            ...
            switch ($action) {
                ...
                case "GETPRODUCTS":
                    ...
                    break;
                case 'INSERTCOMPRA':
                    if(isset($_POST['producto']) && isset($_POST['email']) && isset($_POST['department']) && isset($_POST['subdepartment']) && isset($_POST['cantidad']) && isset($_POST['minimo'])){
                        $sql = sprintf("CALL INSERT_COMPRA('%s',%d,%d,%d,%d,%d);", $_POST['email'], $_POST['department'], $_POST['subdepartment'], $_POST['producto'], $_POST['cantidad'], $_POST['minimo']);
                        if($con = include("database.php")){
                            if($rs = $con->query($sql)){
                                $info['status'] = 200;
                            }else{ 
